...
v0.3 保留 M01–M08、R01–R48，增加前端规范 M09 及 A33–A36。支付名单、四种加密承载、钱包购买、立即重置续费、计量、离线时限、规模与高级功能范围已锁定。Cyber 供应商身份、真实商户与服务器环境仍是外部依赖；容量目标仍需实测。
...
| Cyber | 用户确认 | 最终必交付；供应商完整名称、文档/版本与测试条件未提供，不编造协议、不阻塞其他模块 |
...
| D02 | 支付 | EPay、EPUSDT 原版及 Bepusdt、TokenPay、Cryptomus、Cyber 必交付；Cyber 文档未给，其他模块继续 |
